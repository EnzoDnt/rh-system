...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-sm bg-neutral-100 p-1 text-[var(--color-text-muted)]",
      className
    )}
    {...props}
  />
